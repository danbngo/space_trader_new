...
const PT = {
    ...
    STATE_RELIGION: new PolicyType('State Religion', NF.CULTURE, COLORS.White, [GT.TECHNOCRACY], [GT.THEOCRACY, GT.ARISTOCRACY], 
        [], [NT.RELIGION_REVIVAL, NT.CRACKDOWN, NT.LUDDITISM, NT.CULTURAL_PURGE, NT.INQUISITION], []),
    TOTALITARIANISM: new PolicyType('Totalitarianism', NF.CULTURE, COLORS.DimGray, [GT.DEMOCRACY, GT.ANARCHY], [GT.POLICE_STATE], 
        [NT.REVOLUTION, NT.CRIME_WAVE], [NT.CRACKDOWN, NT.CONSCRIPTION, NT.FORCED_LABOR, NT.CULTURAL_PURGE, NT.EUGENICS, NT.TERRORISM, NT.INQUISITION], []),
    LIBERALISM: new PolicyType('Liberalism', NF.CULTURE, COLORS.Green, [GT.THEOCRACY, GT.POLICE_STATE], [GT.DEMOCRACY, GT.TECHNOCRACY], 
        [NT.CRACKDOWN, NT.GENOCIDE, NT.ENSLAVEMENT, NT.CULTURAL_PURGE, NT.EUGENICS, NT.INQUISITION], [NT.IMMIGRATION, NT.TOURISM, NT.CLONING, NT.CULTURAL_RENAISSANCE], []),
