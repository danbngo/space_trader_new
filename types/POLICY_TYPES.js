...
const PT = {
    ...
    DECENTRALIZATION: new PolicyType('Decentralization', NF.ECONOMY, COLORS.LightGreen, [GT.COMMUNISM], [GT.ANARCHY], 
        ...
        new Map([[FACTION_TYPES.MERCHANTS, 1.2], [FACTION_TYPES.MINERS, 1.3], [FACTION_TYPES.SMUGGLERS, 1.4], [FACTION_TYPES.SALVAGERS, 1.2], [FACTION_TYPES.TAX_COLLECTORS, 0.5], [FACTION_TYPES.REBELS, 1.3]])),
    PROTECTIONISM: new PolicyType('Protectionism', NF.ECONOMY, COLORS.Orange, [GT.ANARCHY], [GT.ARISTOCRACY, GT.POLICE_STATE], 
        ...
        new Map([[FACTION_TYPES.MERCHANTS, 0.5], [FACTION_TYPES.SMUGGLERS, 1.5], [FACTION_TYPES.POLICE, 1.2], [FACTION_TYPES.DIPLOMATS, 0.6], [FACTION_TYPES.TAX_COLLECTORS, 1.3]])),
    CENTRAL_PLANNING: new PolicyType('Central Planning', NF.ECONOMY, COLORS.Red, [GT.ANARCHY, GT.CORPORATISM], [GT.COMMUNISM, GT.TECHNOCRACY], 
        ...
        new Map([[FACTION_TYPES.MINERS, 1.3], [FACTION_TYPES.MERCHANTS, 0.7], [FACTION_TYPES.POLICE, 1.3], [FACTION_TYPES.TAX_COLLECTORS, 1.5]])),
    FREE_TRADE: new PolicyType('Free Trade', NF.ECONOMY, COLORS.Green, [GT.COMMUNISM], [GT.CORPORATISM, GT.DEMOCRACY], 
        ...
        new Map([[FACTION_TYPES.MERCHANTS, 1.5], [FACTION_TYPES.TOURISTS, 1.4], [FACTION_TYPES.SMUGGLERS, 0.7], [FACTION_TYPES.DIPLOMATS, 1.5]])),
    ...
    FORCED_LABOR: new PolicyType('Forced Labor', NF.LABOR, COLORS.Red, [GT.DEMOCRACY, GT.ANARCHY], [GT.POLICE_STATE, GT.COMMUNISM], 
        ...
        new Map([[FACTION_TYPES.POLICE, 1.4], [FACTION_TYPES.SLAVERS, 1.8], [FACTION_TYPES.COLONISTS, 0.4], [FACTION_TYPES.REBELS, 1.6]])),
    ...
    LAISSEZ_FAIRE: new PolicyType('Laissez Faire', NF.LABOR, COLORS.Cyan, [], [GT.TECHNOCRACY, GT.CORPORATISM], 
        ...
        new Map([[FACTION_TYPES.MERCHANTS, 1.4], [FACTION_TYPES.MINERS, 1.3], [FACTION_TYPES.PIRATES, 1.2], [FACTION_TYPES.SALVAGERS, 1.3]])),
    ...
    ETHNIC_NATIONALISM: new PolicyType('Ethnic Nationalism', NF.CULTURE, COLORS.DarkRed, [GT.ANARCHY], [GT.POLICE_STATE, GT.ARISTOCRACY], 
        ...
        new Map([[FACTION_TYPES.SOLDIERS, 1.5], [FACTION_TYPES.POLICE, 1.4], [FACTION_TYPES.TOURISTS, 0.3], [FACTION_TYPES.COLONISTS, 0.5], [FACTION_TYPES.REBELS, 1.4], [FACTION_TYPES.REFUGEES, 1.8]])),
    ...
    TOTALITARIANISM: new PolicyType('Totalitarianism', NF.CULTURE, COLORS.DimGray, [GT.DEMOCRACY, GT.ANARCHY], [GT.POLICE_STATE], 
        ...
        new Map([[FACTION_TYPES.POLICE, 2.0], [FACTION_TYPES.SOLDIERS, 1.8], [FACTION_TYPES.PIRATES, 0.2], [FACTION_TYPES.SMUGGLERS, 0.3], [FACTION_TYPES.TOURISTS, 0.4], [FACTION_TYPES.TAX_COLLECTORS, 2.0], [FACTION_TYPES.REBELS, 1.8], [FACTION_TYPES.REFUGEES, 2.0]])),
    LIBERALISM: new PolicyType('Liberalism', NF.CULTURE, COLORS.Green, [GT.THEOCRACY, GT.POLICE_STATE], [GT.DEMOCRACY, GT.TECHNOCRACY], 
        ...
        new Map([[FACTION_TYPES.TOURISTS, 1.6], [FACTION_TYPES.MERCHANTS, 1.3], [FACTION_TYPES.COLONISTS, 1.4], [FACTION_TYPES.SLAVERS, 0.2], [FACTION_TYPES.INQUISITORS, 0.3], [FACTION_TYPES.TAX_COLLECTORS, 0.7], [FACTION_TYPES.REBELS, 0.5], [FACTION_TYPES.REFUGEES, 0.6]])),
    ...
    IMPERIALISM: new PolicyType('Imperialism', NF.POLITICS, COLORS.Red, [GT.ANARCHY, GT.PUPPET_STATE], [GT.POLICE_STATE, GT.ARISTOCRACY], 
        ...
        new Map([[FACTION_TYPES.SOLDIERS, 2.0], [FACTION_TYPES.COLONISTS, 1.5], [FACTION_TYPES.SLAVERS, 1.4], [FACTION_TYPES.TOURISTS, 0.6], [FACTION_TYPES.TAX_COLLECTORS, 1.4], [FACTION_TYPES.REFUGEES, 1.7]])),
    ISOLATIONISM: new PolicyType('Isolationism', NF.POLITICS, COLORS.Gray, [GT.PUPPET_STATE], [GT.POLICE_STATE, GT.THEOCRACY], 
        ...
        new Map([[FACTION_TYPES.MERCHANTS, 0.3], [FACTION_TYPES.SOLDIERS, 0.4], [FACTION_TYPES.TOURISTS, 0.3], [FACTION_TYPES.COLONISTS, 0.5], [FACTION_TYPES.MINERS, 1.2], [FACTION_TYPES.SCIENTISTS, 1.1], [FACTION_TYPES.DIPLOMATS, 0.2], [FACTION_TYPES.SALVAGERS, 1.1]])),
    COMMERCIALISM: new PolicyType('Commercialism', NF.POLITICS, COLORS.Yellow, [], [GT.DEMOCRACY, GT.CORPORATISM], 
        ...
        new Map([[FACTION_TYPES.MERCHANTS, 1.8], [FACTION_TYPES.TOURISTS, 1.5], [FACTION_TYPES.SOLDIERS, 0.7], [FACTION_TYPES.PIRATES, 1.2], [FACTION_TYPES.DIPLOMATS, 1.4], [FACTION_TYPES.SALVAGERS, 1.2]])),
    UNIVERSALISM: new PolicyType('Universalism', NF.POLITICS, COLORS.LightGreen, [GT.POLICE_STATE], [GT.DEMOCRACY, GT.THEOCRACY], 
        ...
        new Map([[FACTION_TYPES.COLONISTS, 1.4], [FACTION_TYPES.MISSIONARIES, 1.5], [FACTION_TYPES.TOURISTS, 1.3], [FACTION_TYPES.SOLDIERS, 0.8], [FACTION_TYPES.SLAVERS, 0.2], [FACTION_TYPES.DIPLOMATS, 1.8], [FACTION_TYPES.REFUGEES, 0.5]])),
