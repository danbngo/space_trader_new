...
const RACES = {
    ...
    ANDROID: new Race(
        ...
        1,
        [PERK_TYPES.TECH_SAVVY_1, PERK_TYPES.TECH_SAVVY_2, PERK_TYPES.TECH_SAVVY_3, PERK_TYPES.TECH_SAVVY_4, PERK_TYPES.TECH_SAVVY_5,
         PERK_TYPES.LIFE_EXTENSION_1, PERK_TYPES.LIFE_EXTENSION_2, PERK_TYPES.LIFE_EXTENSION_3, PERK_TYPES.LIFE_EXTENSION_4, PERK_TYPES.LIFE_EXTENSION_5]
    ),
    CYBORG: new Race(
        'Cyborg',
        COLORS.Gray,
