...
const NEWS_TYPES = {
    ...
    COUP_DETAT: new NewsType('Coup d\'Etat', COLORS.Red, 2, 5, 1), //one planet overthrows another planet's government
...
const NEWS_TYPES_COOPERATION_PREVENTING = [NEWS_TYPES.WAR, NEWS_TYPES.BOMBARDMENT, NEWS_TYPES.EMBARGO, NEWS_TYPES.TENSIONS, NEWS_TYPES.COUP_DETAT]
...
const NEWS_TYPES_MARTIAL = [NEWS_TYPES.MILITARY_BUILDUP, NEWS_TYPES.WAR, NEWS_TYPES.EMBARGO, NEWS_TYPES.BOMBARDMENT, NEWS_TYPES.CIVIL_WAR, NEWS_TYPES.ARMS_DEAL, NEWS_TYPES.COUP_DETAT]
const NEWS_TYPES_DANGEROUS = [NEWS_TYPES.WAR, NEWS_TYPES.BOMBARDMENT, NEWS_TYPES.CIVIL_WAR, NEWS_TYPES.CIVIL_STRIFE, NEWS_TYPES.COUP_DETAT, NEWS_TYPES.PLAGUE, NEWS_TYPES.ENVIRONMENTAL_DISASTER]
const NEWS_TYPES_ECONOMY_PREVENTING = [NEWS_TYPES.DEPRESSION, NEWS_TYPES.SCARCITY, NEWS_TYPES.PLAGUE, NEWS_TYPES.ENVIRONMENTAL_DISASTER, NEWS_TYPES.EMBARGO, NEWS_TYPES.STOCK_MARKET_CRASH]
const NEWS_TYPES_ECONOMY_BOOSTING = [NEWS_TYPES.ECONOMIC_BOOM, NEWS_TYPES.SCIENTIFIC_BREAKTHROUGH, NEWS_TYPES.INVESTMENT, NEWS_TYPES.SURPLUS, NEWS_TYPES.FOREIGN_AID]
const NEWS_TYPES_CRIME_PREVENTING = [NEWS_TYPES.CRACKDOWN, NEWS_TYPES.REVOLUTION, NEWS_TYPES.CIVIL_WAR, NEWS_TYPES.COUP_DETAT]
