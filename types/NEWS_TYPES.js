...
class NewsType {
     ...
     */
    constructor(
        name = '', color = COLORS.White, minYears = null, maxYears = null, displayPriority = 0, 
...
const NT = {
    ...
    FOREIGN_AID: new NewsType('Foreign Aid', COLORS.LightBlue, 3, 8, 1, [], [], []), //one planet sends economic aid to another
    ...
    LUDDITISM: new NewsType('Ludditism', COLORS.DimGray, 3, 8, 1, [], [], []), //temporary decrease in industrial and commercial ratings
