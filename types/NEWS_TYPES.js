...
const VASSALS = [OBJECT_TYPES.SPACE_STATION]
...
const NT = {
    ...
    CONSTRUCTION: new NewsType('Construction', NF.CONSTRUCTION, 3, 8, 1, [], [GT.CORPORATISM, GT.TECHNOCRACY], []),
    ...
    CLONING: new NewsType('Cloning', NF.HEALTH, 5, 15, 1, [GT.DEMOCRACY, GT.THEOCRACY], [GT.TECHNOCRACY, GT.CORPORATISM], []),
    ...
    IMMIGRATION: new NewsType('Immigration', NF.POLITICS, 5, 10, 1, [], [GT.DEMOCRACY, GT.CORPORATISM], [GT.POLICE_STATE, GT.COMMUNISM]),
    REFUGEES: new NewsType('Refugees', NF.POLITICS, 3, 10, 1, [], [GT.DEMOCRACY, GT.THEOCRACY], [GT.POLICE_STATE]),
    ...
    LIFE_EXTENSION: new NewsType('Life Extension', NF.HEALTH, 8, 20, 1, [GT.ANARCHY, GT.THEOCRACY], [GT.TECHNOCRACY, GT.CORPORATISM], []),
    ARTIFICIAL_WOMBS: new NewsType('Artificial Wombs', NF.HEALTH, 5, 15, 1, [GT.ANARCHY, GT.THEOCRACY], [GT.TECHNOCRACY, GT.CORPORATISM], []),
    LEGALLY_ASSISTED_DEATH: new NewsType('Assisted Death', NF.HEALTH, 3, 10, 1, [GT.ANARCHY], [GT.DEMOCRACY, GT.ARISTOCRACY], []),
    VIRTUAL_REALITY_CHAMBERS: new NewsType('Virtual Reality Chambers', NF.HEALTH, 5, 15, 1, [GT.ANARCHY, GT.THEOCRACY], [GT.TECHNOCRACY, GT.CORPORATISM], []),
    ARTIFICIAL_LIFE: new NewsType('Artificial Life', NF.HEALTH, 5, 15, 1, [GT.ANARCHY, GT.THEOCRACY], [GT.TECHNOCRACY, GT.CORPORATISM], []),
    ...
    PLAGUE_VACCINE: new NewsType('Plague Vaccine', NF.HEALTH, 5, 15, 1, [GT.ANARCHY, GT.PUPPET_STATE], [GT.DEMOCRACY, GT.TECHNOCRACY], []),
    ...
    SUPER_SOLDIERS: new NewsType('Super Soldiers', NF.SCIENCE, 7, 15, 1, [GT.DEMOCRACY, GT.ANARCHY], [GT.POLICE_STATE, GT.TECHNOCRACY], []),
    ...
    PLANETARY_DEFENSE: new NewsType('Planetary Defense Platform', NF.CONSTRUCTION, 5, 15, 1, [GT.ANARCHY, GT.PUPPET_STATE], [GT.POLICE_STATE, GT.ARISTOCRACY], []),
    SPACE_ELEVATOR: new NewsType('Space Elevator', NF.CONSTRUCTION, 8, 20, 1, [GT.ANARCHY, GT.PUPPET_STATE], [GT.TECHNOCRACY, GT.CORPORATISM], []),
    ANTIMATTER_GRID: new NewsType('Antimatter Power Grid', NF.CONSTRUCTION, 8, 20, 1, [GT.ANARCHY, GT.THEOCRACY], [GT.TECHNOCRACY, GT.CORPORATISM], []),
    MEGACITY: new NewsType('Megacity', NF.CONSTRUCTION, 10, 25, 1, [GT.ANARCHY, GT.PUPPET_STATE], [GT.CORPORATISM, GT.DEMOCRACY], []),
    ...
    SPORTS_EVENT: new NewsType('Interplanetary Games', NF.CULTURE, 3, 8, 1, [], [GT.DEMOCRACY, GT.CORPORATISM], []),
    HOLO_CULTURE: new NewsType('Holo-Culture Boom', NF.CULTURE, 5, 15, 1, [GT.POLICE_STATE], [GT.DEMOCRACY, GT.CORPORATISM], []),
    SOCIAL_MEDIA: new NewsType('Social Media', NF.CULTURE, 5, 15, 1, [GT.ANARCHY], [GT.TECHNOCRACY, GT.DEMOCRACY], []),
    ...
    ATMOSPHERE_RESTORATION: new NewsType('Atmosphere Restoration', NF.ECOLOGY, 8, 20, 1, [GT.ANARCHY, GT.PUPPET_STATE], [GT.TECHNOCRACY, GT.DEMOCRACY], []),
    POLLUTION_CLEANUP: new NewsType('Pollution Cleanup', NF.ECOLOGY, 5, 15, 1, [GT.ANARCHY, GT.PUPPET_STATE], [GT.DEMOCRACY, GT.TECHNOCRACY], []),
    OCEAN_RESTORATION: new NewsType('Ocean Restoration', NF.ECOLOGY, 10, 25, 1, [GT.ANARCHY, GT.PUPPET_STATE], [GT.TECHNOCRACY, GT.CORPORATISM], []),
    ORBITAL_SHIELDS: new NewsType('Orbital Shields', NF.ECOLOGY, 8, 20, 1, [GT.ANARCHY, GT.PUPPET_STATE], [GT.TECHNOCRACY], []),
    ASTEROID_STEERING: new NewsType('Asteroid Steering', NF.ECOLOGY, 5, 15, 1, [GT.ANARCHY, GT.PUPPET_STATE], [GT.TECHNOCRACY], []),
    MANTLE_HEATING: new NewsType('Mantle Heating', NF.ECOLOGY, 10, 30, 1, [GT.ANARCHY, GT.PUPPET_STATE], [GT.TECHNOCRACY], []),
    HEAT_RADIATOR: new NewsType('Heat Radiator', NF.ECOLOGY, 8, 20, 1, [GT.ANARCHY, GT.PUPPET_STATE], [GT.TECHNOCRACY, GT.CORPORATISM], []),
