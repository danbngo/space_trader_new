...
const NT_COOPERATION_PREVENTING = [...NT_WARLIKE, NT.EMBARGO, NT.TENSIONS, NT.COUP_DETAT, NT.PLAGUE]
const NT_COOPERATIVE = [NT.ALLIANCE, NT.TRADE_AGREEMENT, NT.RESEARCH_AGREEMENT, NT.INVESTMENT, NT.ARMS_DEAL]
const NT_MARTIAL = [...NT_WARLIKE, NT.MILITARY_BUILDUP, NT.EMBARGO, NT.CIVIL_WAR, NT.ARMS_DEAL, NT.COUP_DETAT]
