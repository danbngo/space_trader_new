...
const FLEET_TYPES = {
    ...
    ASTEROIDS_STORM: new FleetType('Asteroid Storm', [ASTEROID_SHIP_TYPES.ASTEROID], 30, 50, 0, [CARGO_TYPES.METAL, CARGO_TYPES.WATER, CARGO_TYPES.METAL, CARGO_TYPES.WATER, CARGO_TYPES.METAL, CARGO_TYPES.WATER, CARGO_TYPES.ISOTOPES]),
    ASTEROIDS_CALM: new FleetType('Asteroid Field', [ASTEROID_SHIP_TYPES.ASTEROID], 10, 20, 0, [CARGO_TYPES.METAL, CARGO_TYPES.WATER, CARGO_TYPES.METAL, CARGO_TYPES.WATER, CARGO_TYPES.METAL, CARGO_TYPES.WATER, CARGO_TYPES.ISOTOPES]),
    CRYOIDS_STORM: new FleetType('Cryoid Storm', [ASTEROID_SHIP_TYPES.CRYOID], 30, 50, 0, [CARGO_TYPES.METAL, CARGO_TYPES.WATER, CARGO_TYPES.WATER, CARGO_TYPES.WATER, CARGO_TYPES.ISOTOPES]),
    CRYOIDS_CALM: new FleetType('Cryoid Field', [ASTEROID_SHIP_TYPES.CRYOID], 10, 20, 0, [CARGO_TYPES.METAL, CARGO_TYPES.WATER, CARGO_TYPES.WATER, CARGO_TYPES.WATER, CARGO_TYPES.ISOTOPES]),
    PLASMOIDS_STORM: new FleetType('Plasmoid Storm', [ASTEROID_SHIP_TYPES.PLASMOID], 30, 50, 0, [CARGO_TYPES.ISOTOPES]),
    PLASMOIDS_CALM: new FleetType('Plasmoid Field', [ASTEROID_SHIP_TYPES.PLASMOID], 10, 20, 0, [CARGO_TYPES.ISOTOPES]),
