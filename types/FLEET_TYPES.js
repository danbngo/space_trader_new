...
const FLEET_TYPES = {
    SOLDIERS: new FleetType('Soldiers', [SHIP_TYPES.BATTLESHIP, SHIP_TYPES.DESTROYER, SHIP_TYPES.SCOUT, SHIP_TYPES.FIGHTER], 3, 7, 500, [CARGO_TYPES.FOOD, CARGO_TYPES.WATER, CARGO_TYPES.WEAPONS, CARGO_TYPES.ANTIMATTER], 4, 12, CHASE_DISTANCES.NEAR),
    ...
    TOURISTS: new FleetType('Tourists', [SHIP_TYPES.PASSENGER_SHIP, SHIP_TYPES.GUARD_SHIP], 1, 3, 10000, [CARGO_TYPES.FOOD, CARGO_TYPES.WATER, CARGO_TYPES.DRUGS, CARGO_TYPES.HOLOCUBES], 5, 15),
    COLONISTS: new FleetType('Colonists', [SHIP_TYPES.PASSENGER_SHIP, SHIP_TYPES.GUARD_SHIP], 1, 3, 4000, [CARGO_TYPES.FOOD, CARGO_TYPES.WATER], 10, 20),
    SCIENTISTS: new FleetType('Scientists', [SHIP_TYPES.SCOUT], 1, 3, 3000, [CARGO_TYPES.RELICS, CARGO_TYPES.ISOTOPES, CARGO_TYPES.NANITES, CARGO_TYPES.ANTIMATTER], 3, 8),
    PILGRIMS: new FleetType('Pilgrims', [SHIP_TYPES.PASSENGER_SHIP], 1, 3, 2000, [CARGO_TYPES.FOOD, CARGO_TYPES.WATER, CARGO_TYPES.RELICS], 5, 15),
    INQUISITORS: new FleetType('Inquisitors', [SHIP_TYPES.PATROL_SHIP, SHIP_TYPES.DESTROYER], 2, 4, 3000, [CARGO_TYPES.WEAPONS, CARGO_TYPES.RELICS], 3, 10, CHASE_DISTANCES.NEAR),
    MISSIONARIES: new FleetType('Missionaries', [SHIP_TYPES.SHUTTLE], 1, 2, 1500, [CARGO_TYPES.FOOD, CARGO_TYPES.WATER, CARGO_TYPES.RELICS], 4, 12),
