...
const FLEET_TYPES = {
    ...
    ASTEROIDS: new FleetType('Asteroids', [ASTEROID_SHIP_TYPES.ASTEROID], 30, 50, 0, [CARGO_TYPES.METAL, CARGO_TYPES.ICE, CARGO_TYPES.METAL, CARGO_TYPES.ICE, CARGO_TYPES.METAL, CARGO_TYPES.ICE, CARGO_TYPES.ISOTOPES]),
    CRYOIDS: new FleetType('Cryoids', [ASTEROID_SHIP_TYPES.CRYOID], 30, 50, 0, [CARGO_TYPES.METAL, CARGO_TYPES.ICE, CARGO_TYPES.ICE, CARGO_TYPES.ICE, CARGO_TYPES.ISOTOPES]),
