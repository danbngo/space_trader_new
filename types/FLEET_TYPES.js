...
const FLEET_TYPES = {
    ...
    EXPLORERS: new FleetType('Explorers', [SHIP_TYPES.SCOUT, SHIP_TYPES.FIGHTER], 1, 3, [CARGO_TYPES.BIOGEL, CARGO_TYPES.HOLOCUBES, CARGO_TYPES.NANITES]),
    SMUGGLERS: new FleetType('Smugglers', [SHIP_TYPES.FIGHTER], 1, 3, [CARGO_TYPES.DRUGS, CARGO_TYPES.CLONES, CARGO_TYPES.WEAPONS]),
