...
const FLEET_TYPES = {
    POLICE: new FleetType('Police', [SHIP_TYPES.GUARD_SHIP], 1, 5, 500, []),
    PIRATES: new FleetType('Pirates', [SHIP_TYPES.FIGHTER, SHIP_TYPES.BATTLESHIP], 1, 5, 10000, CARGO_TYPES_ALL),
    ...
    SOLDIERS: new FleetType('Soldiers', [SHIP_TYPES.BATTLESHIP, SHIP_TYPES.DESTROYER, SHIP_TYPES.SCOUT], 3, 5, 500, [CARGO_TYPES.WEAPONS]),
    ...
    ASTEROIDS: new FleetType('Asteroids', [PSEUDO_SHIP_TYPES.ASTEROID], 15, 40, 0, [CARGO_TYPES.METAL, CARGO_TYPES.ICE, CARGO_TYPES.METAL, CARGO_TYPES.ICE, CARGO_TYPES.METAL, CARGO_TYPES.ICE, CARGO_TYPES.ISOTOPES]),
    CRYOIDS: new FleetType('Cryoids', [PSEUDO_SHIP_TYPES.CRYOID], 10, 25, 0, [CARGO_TYPES.METAL, CARGO_TYPES.ICE, CARGO_TYPES.ICE, CARGO_TYPES.ICE, CARGO_TYPES.ISOTOPES]),
    PLASMOIDS: new FleetType('Plasmoids', [PSEUDO_SHIP_TYPES.PLASMOID], 12, 30, 0, [CARGO_TYPES.ISOTOPES]),
}
