...
const FLEET_TYPES = {
    ...
    ASTEROIDS: new FleetType('Asteroids', [PSEUDO_SHIP_TYPES.ASTEROID], 15, 30, 0, [CARGO_TYPES.METAL, CARGO_TYPES.ICE, CARGO_TYPES.METAL, CARGO_TYPES.ICE, CARGO_TYPES.METAL, CARGO_TYPES.ICE, CARGO_TYPES.ISOTOPES]),
    CRYOIDS: new FleetType('Cryoids', [PSEUDO_SHIP_TYPES.CRYOID], 15, 30, 0, [CARGO_TYPES.METAL, CARGO_TYPES.ICE, CARGO_TYPES.ICE, CARGO_TYPES.ICE, CARGO_TYPES.ISOTOPES]),
    PLASMOIDS: new FleetType('Plasmoids', [PSEUDO_SHIP_TYPES.PLASMOID], 15, 30, 0, [CARGO_TYPES.ISOTOPES]),
}
