...
const FLEET_TYPES = {
    ...
    MERCENARIES: new FleetType('Mercenaries', [SHIP_TYPES.FRIGATE, SHIP_TYPES.DESTROYER, SHIP_TYPES.FIGHTER], 2, 6, 1500, [CARGO_TYPES.FOOD, CARGO_TYPES.WATER, CARGO_TYPES.WEAPONS], 0.1, CHASE_DISTANCES.NEAR),
    ...
    SYNDICATES: new FleetType('Syndicates', [SHIP_TYPES.INTERCEPTOR, SHIP_TYPES.FIGHTER, SHIP_TYPES.JAMMER, SHIP_TYPES.BLOCKADE_RUNNER], 2, 4, 8000, [CARGO_TYPES.DRUGS, CARGO_TYPES.WEAPONS, CARGO_TYPES.ANTIMATTER, CARGO_TYPES.DRUGS], 0.08, CHASE_DISTANCES.NEAR),
}
