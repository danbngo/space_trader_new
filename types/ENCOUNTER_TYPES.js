...
const ENCOUNTER_TYPES = {
    ...
    SCIENTISTS: new EncounterType('Scientists', COLORS.Cyan, 'You encountered: scientists.', FACTION_TYPES.SCIENTISTS, FLEET_TYPES.SCIENTISTS, AI_TYPES.Ship, FORMATION_TYPES.FaceOff, ScientistsEncounter),
    ...
    ASTEROIDS_STORM: new EncounterType('Asteroid Storm', COLORS.LightGray, 'You encountered: an asteroid storm.', null, PSEUDO_FLEET_TYPES.ASTEROIDS_STORM, AI_TYPES.Asteroid, FORMATION_TYPES.Storm, AsteroidsStormEncounter, 60),
    ASTEROIDS_CALM: new EncounterType('Asteroid Field', COLORS.LightGray, 'You encountered: an asteroid field.', null, PSEUDO_FLEET_TYPES.ASTEROIDS_CALM, AI_TYPES.Asteroid, FORMATION_TYPES.Storm, AsteroidsCalmEncounter, 60),
    CRYOIDS_STORM: new EncounterType('Cryoid Storm', COLORS.LightBlue, 'You encountered: a cryoid storm.', null, PSEUDO_FLEET_TYPES.CRYOIDS_STORM, AI_TYPES.Asteroid, FORMATION_TYPES.Storm, CryoidsStormEncounter, 60),
    CRYOIDS_CALM: new EncounterType('Cryoid Field', COLORS.LightBlue, 'You encountered: a cryoid field.', null, PSEUDO_FLEET_TYPES.CRYOIDS_CALM, AI_TYPES.Asteroid, FORMATION_TYPES.Storm, CryoidsCalmEncounter, 60),
    PLASMOIDS_STORM: new EncounterType('Plasmoid Storm', COLORS.LightRed, 'You encountered: a plasmoid storm.', null, PSEUDO_FLEET_TYPES.PLASMOIDS_STORM, AI_TYPES.Asteroid, FORMATION_TYPES.Storm, PlasmoidsStormEncounter, 60),
    PLASMOIDS_CALM: new EncounterType('Plasmoid Field', COLORS.LightRed, 'You encountered: a plasmoid field.', null, PSEUDO_FLEET_TYPES.PLASMOIDS_CALM, AI_TYPES.Asteroid, FORMATION_TYPES.Storm, PlasmoidsCalmEncounter, 60),
    MAGNETOIDS_STORM: new EncounterType('Magnetoid Storm', COLORS.LightPurple, 'You encountered: a magnetoid storm.', null, PSEUDO_FLEET_TYPES.MAGNETOIDS_STORM, AI_TYPES.Asteroid, FORMATION_TYPES.Storm, MagnetoidsStormEncounter, 60),
    MAGNETOIDS_CALM: new EncounterType('Magnetoid Field', COLORS.LightPurple, 'You encountered: a magnetoid field.', null, PSEUDO_FLEET_TYPES.MAGNETOIDS_CALM, AI_TYPES.Asteroid, FORMATION_TYPES.Storm, MagnetoidsCalmEncounter, 60),
}
