...
const RANK_TYPES = {
    ...
    CITIZEN: new RankType('Citizen', COLORS.LightBlue, 2, 10000, 25, 'Full citizenship with voting rights and legal protections. Eligible for government contracts and preferred trade rates.'),
