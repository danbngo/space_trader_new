...
// Dwarf Planets
const CERES = new DwarfPlanet("Ceres", hexToRgba('#999999'), 0.076, new Orbit(2.77), PLANET_TYPES.TERRESTRIAL, null, null,
...
const PLUTO = new DwarfPlanet("Pluto", hexToRgba('#d4a373'), 0.186, new Orbit(39.48), PLANET_TYPES.TERRESTRIAL, null, null,
...
const ERIS = new DwarfPlanet("Eris", hexToRgba('#cccccc'), 0.182, new Orbit(67.7), PLANET_TYPES.TERRESTRIAL, null, null,
...
const HAUMEA = new DwarfPlanet("Haumea", hexToRgba('#e8e8e8'), 0.128, new Orbit(43.13), PLANET_TYPES.TERRESTRIAL, null, null,
...
const MAKEMAKE = new DwarfPlanet("Makemake", hexToRgba('#c9a687'), 0.116, new Orbit(45.79), PLANET_TYPES.TERRESTRIAL, null, null,
