...
const MERCURY = new Planet("Mercury", hexToRgba('#aaaaaa'), 0.383, new Orbit(0.39), PLANET_TYPES.TERRESTRIAL, null, null, 
    null,
    [PLANET_FEATURE_TYPES.EXTREMELY_HOT, PLANET_FEATURE_TYPES.NO_ATMOSPHERE, PLANET_FEATURE_TYPES.HIGH_RADIATION, PLANET_FEATURE_TYPES.NO_MAGNETOSPHERE], 58.6, 0.0003);
const VENUS = new Planet("Venus", hexToRgba('#d4e642'), 0.949, new Orbit(0.72), PLANET_TYPES.GAS_DWARF, null, null,
    null,
    [PLANET_FEATURE_TYPES.EXTREMELY_HOT, PLANET_FEATURE_TYPES.THICK_ATMOSPHERE, PLANET_FEATURE_TYPES.GREENHOUSE_EFFECT, PLANET_FEATURE_TYPES.DENSE_CLOUDS, PLANET_FEATURE_TYPES.VOLCANIC_ACTIVITY, PLANET_FEATURE_TYPES.NO_MAGNETOSPHERE], 243, 0.0001);
const EARTH = new Planet("Earth", hexToRgba('#4a90e2'), 1.0, new Orbit(1.0), PLANET_TYPES.EARTHLIKE, null, null,
    null,
    [PLANET_FEATURE_TYPES.OCEAN_WORLD, PLANET_FEATURE_TYPES.THICK_ATMOSPHERE, PLANET_FEATURE_TYPES.STRONG_MAGNETOSPHERE, PLANET_FEATURE_TYPES.ICE_CAPS], 1.0, 0.0007);
const MARS = new Planet("Mars", hexToRgba('#b22222'), 0.532, new Orbit(1.52), PLANET_TYPES.TERRESTRIAL, null, null,
    null,
    [PLANET_FEATURE_TYPES.EXTREMELY_COLD, PLANET_FEATURE_TYPES.THIN_ATMOSPHERE, PLANET_FEATURE_TYPES.DRY_WORLD, PLANET_FEATURE_TYPES.ICE_CAPS, PLANET_FEATURE_TYPES.LOW_GRAVITY, PLANET_FEATURE_TYPES.WEAK_MAGNETOSPHERE], 1.03, 0.0001);
const JUPITER = new Planet("Jupiter", hexToRgba('#d9955b'), 11.21, new Orbit(5.2), PLANET_TYPES.GAS_GIANT, null, null,
    null,
    [PLANET_FEATURE_TYPES.THICK_ATMOSPHERE, PLANET_FEATURE_TYPES.GREAT_STORM, PLANET_FEATURE_TYPES.STRONG_MAGNETOSPHERE, PLANET_FEATURE_TYPES.RADIATION_BELTS, PLANET_FEATURE_TYPES.HIGH_GRAVITY], 0.41, 0.05);
const SATURN = new Planet("Saturn", hexToRgba('#faf0d7'), 9.45, new Orbit(9.58), PLANET_TYPES.GAS_GIANT, null, null,
    null,
    [PLANET_FEATURE_TYPES.THICK_ATMOSPHERE, PLANET_FEATURE_TYPES.RING_SYSTEM, PLANET_FEATURE_TYPES.STRONG_MAGNETOSPHERE, PLANET_FEATURE_TYPES.HIGH_GRAVITY], 0.45, 0.013);
const URANUS = new Planet("Uranus", hexToRgba('#afeeee'), 4.01, new Orbit(19.2), PLANET_TYPES.ICE_GIANT, null, null,
    null,
    [PLANET_FEATURE_TYPES.EXTREMELY_COLD, PLANET_FEATURE_TYPES.THICK_ATMOSPHERE, PLANET_FEATURE_TYPES.WEAK_MAGNETOSPHERE], 0.72, 0.004);
const NEPTUNE = new Planet("Neptune", hexToRgba('#4169e1'), 3.88, new Orbit(30.05), PLANET_TYPES.ICE_GIANT, null, null,
    null,
    [PLANET_FEATURE_TYPES.EXTREMELY_COLD, PLANET_FEATURE_TYPES.THICK_ATMOSPHERE, PLANET_FEATURE_TYPES.GREAT_STORM, PLANET_FEATURE_TYPES.WEAK_MAGNETOSPHERE], 0.67, 0.0015);

// Dwarf Planets
const CERES = new Planet("Ceres", hexToRgba('#999999'), 0.076, new Orbit(2.77), PLANET_TYPES.TERRESTRIAL, null, null,
    null,
    [PLANET_FEATURE_TYPES.EXTREMELY_COLD, PLANET_FEATURE_TYPES.NO_ATMOSPHERE, PLANET_FEATURE_TYPES.WATER_ICE_SURFACE, PLANET_FEATURE_TYPES.SUBSURFACE_OCEAN, PLANET_FEATURE_TYPES.LOW_GRAVITY], 0.38, 0);
const PLUTO = new Planet("Pluto", hexToRgba('#d4a373'), 0.186, new Orbit(39.48), PLANET_TYPES.TERRESTRIAL, null, null,
    null,
    [PLANET_FEATURE_TYPES.EXTREMELY_COLD, PLANET_FEATURE_TYPES.THIN_ATMOSPHERE, PLANET_FEATURE_TYPES.WATER_ICE_SURFACE, PLANET_FEATURE_TYPES.LOW_GRAVITY, PLANET_FEATURE_TYPES.NO_MAGNETOSPHERE], 6.4, 0);
const ERIS = new Planet("Eris", hexToRgba('#cccccc'), 0.182, new Orbit(67.7), PLANET_TYPES.TERRESTRIAL, null, null,
    null,
    [PLANET_FEATURE_TYPES.EXTREMELY_COLD, PLANET_FEATURE_TYPES.NO_ATMOSPHERE, PLANET_FEATURE_TYPES.WATER_ICE_SURFACE, PLANET_FEATURE_TYPES.LOW_GRAVITY], 1.1, 0);
const HAUMEA = new Planet("Haumea", hexToRgba('#e8e8e8'), 0.128, new Orbit(43.13), PLANET_TYPES.TERRESTRIAL, null, null,
    null,
    [PLANET_FEATURE_TYPES.EXTREMELY_COLD, PLANET_FEATURE_TYPES.NO_ATMOSPHERE, PLANET_FEATURE_TYPES.WATER_ICE_SURFACE, PLANET_FEATURE_TYPES.LOW_GRAVITY], 0.16, 0);
const MAKEMAKE = new Planet("Makemake", hexToRgba('#c9a687'), 0.116, new Orbit(45.79), PLANET_TYPES.TERRESTRIAL, null, null,
    null,
    [PLANET_FEATURE_TYPES.EXTREMELY_COLD, PLANET_FEATURE_TYPES.THIN_ATMOSPHERE, PLANET_FEATURE_TYPES.WATER_ICE_SURFACE, PLANET_FEATURE_TYPES.LOW_GRAVITY], 0.95, 0);
