...
class Settlement {
     ...
     */
    constructor({planet = new Planet(), settlementType = null, shipyard = null, market = null, guild = null}) {
        /** @type {string} */
    ...
    get buildings() {
        return [this.guild, this.market, this.shipyard]
    }
    ...
    clone() {
        return new Settlement({
            // @ts-ignore
            planet: this.planet, settlementType: this.settlementType, shipyard: this.shipyard ? this.shipyard.clone() : null, market: this.market ? this.market.clone() : null, guild: this.guild ? this.guild.clone() : null
        })
    }
}
