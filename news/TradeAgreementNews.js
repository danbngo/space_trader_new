class TradeAgreementNews extends News {
    ...
    determineOutcome() {
        ...
        const economyCheck = (p.c.economy < CL.LOW) || (targetPlanet.c.economy < CL.LOW)
    ...
    isValid() {
        ...
        const govTypesValid = p.c.governmentType.opposingType !== targetPlanet.c.governmentType && targetPlanet.c.governmentType.opposingType !== p.c.governmentType
