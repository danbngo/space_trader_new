class AuthoritiesEncounter extends FleetEncounter {
    ...
    showFineOrJailModal(fine = 0) {
        ...
        const fineFromBounty = Math.ceil(Math.min(Math.max(currentBounty * Math.random() * ENCOUNTER_MAX_BOUNTY_OR_JAIL_RATIO, 100), currentBounty * ENCOUNTER_MAX_BOUNTY_OR_JAIL_RATIO))
