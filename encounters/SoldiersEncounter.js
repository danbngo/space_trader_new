...
class SoldiersEncounter extends AuthoritiesEncounter {
    onStart() {
        ...
        else if (this.luck[1]*gs.captain.calcReputationForPlanet(this.planet) > 300 && gs.captain.calcBountyForPlanet(this.planet) > 0) {
        ...
        if (this.luck[2]*gs.captain.calcReputationForPlanet(this.planet) < 300 && gs.captain.calcBountyForPlanet(this.planet) > 0) {
