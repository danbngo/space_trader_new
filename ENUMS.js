...
const SHAPES = Object.freeze({
    ...
    //ClearRect: 'ClearRect', // Black overlay with cleared rectangular area (efficient spotlight)
    ClearCircle: 'ClearCircle', // Black overlay with cleared rectangular area (efficient spotlight)
